...
try{
	if (typeof(lpUnit)=='undefined') { var lpUnit='o2-service'; }
...
// LP Button Code
lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {'name':'chat-'+lpUnit,'pid':'lpbutton-div','afterStartPage': true};
lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {'name':'chat-o2-service-MyO2-PAYM-ContactUs','pid':'lpbutton-MyO2-PAYM-ContactUs','afterStartPage': true};
lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {'name':'chat-o2-service-MyO2-PG-ContactUs','pid':'lpbutton-MyO2-PG-ContactUs','afterStartPage': true};