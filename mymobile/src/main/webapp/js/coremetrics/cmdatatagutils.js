 ...
 *
 * 9/9/2008		   	WBIRD		Added auto-techprops code to the library
 * 1/8/2009		   	WBIRD    	Switched from 3rd to 1st party "www1.o2.co.uk"
...
var cmLoc = window.location.href;
var cmParmStartIndex = cmLoc.indexOf('?');
var cmHostMatch = (cmParmStartIndex == -1) ? cmLoc : cmLoc.substring(0,cmParmStartIndex);

var cm_domains=new Array();
...
function cmSetProduction(coreMetricsUrl){
    cm_HOST=coreMetricsUrl;
}
 ...
 * customerMobile   : optional. Mobile number of Customer
 */
