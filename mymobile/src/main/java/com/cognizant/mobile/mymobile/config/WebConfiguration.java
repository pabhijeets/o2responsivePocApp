package com.cognizant.mobile.mymobile.config;

import com.cognizant.mobile.mymobile.security.CustomAuthenticationProvider;
...
@Configuration
@ComponentScan(basePackages = "com.cognizant.mobile.mymobile", excludeFilters = {
